            ...
            <div className="flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul className="flex flex-col gap-8 mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <Link href="/" className='block py-2 pr-4 pl-3 text-white text-lg rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white'>Home</Link>
                        </li>
                        <li>
                            <Link href="/resume" className='block py-2 pr-4 pl-3 opacity-70 text-white text-lg lg:p-0'>Resume</Link>
                        </li>
                    </ul>
                </div>
